...
void fhog28(cv::MatND &fhog_feature, cv::MatND &fhog_feature2, const cv::Mat& input, int binSize = 4,int nOrients = 9,float clip=0.2f,bool crop = false);
void fhog31(cv::MatND &fhog_feature, const cv::Mat& input, cv::Mat& tmp1, cv::Mat& tmp2, int binSize = 4,int nOrients = 9,float clip=0.2f,bool crop = false);
